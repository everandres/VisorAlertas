...
export const DataProvider = ({ children }) => {
  ...
  } = useFetchData("http://192.168.1.65:8000/api/v1/incendios");
  const {
    data: departamentosData,
    isLoading: departamentosLoading,
    error: departamentosError,
  } = useFetchData("http://192.168.1.65:8000/api/v1/departamentos");
  ...
  } = useFetchData("http://192.168.1.65:8000/api/v1/deslizamientos");
