...
export const DataProvider = ({ children }) => {
  ...
  } = useFetchData("http://localhost:8000/api/v1/incendios");
  const {
    data: departamentosData,
    isLoading: departamentosLoading,
    error: departamentosError,
  } = useFetchData("http://localhost:8000/api/v1/departamentos");
  ...
  } = useFetchData("http://localhost:8000/api/v1/deslizamientos");
